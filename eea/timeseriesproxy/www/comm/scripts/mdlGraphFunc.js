...
//------------------------------------------------------------------		
	function _setTextExportGraphSection(strType){	
		...
		if (strType!="")
		{
			...
			$('#graphSection_PDF').html("<img src='/comm/images/PDF_downlaod_disable.png'>");
			$('#graphSection_PNG').html("<img src='/comm/images/PNG_downlaod_disable.png'>");
			$('#graphSection_PLAYInit').html("<br><a href='' onClick="+'"'+"submitGraph();return false;"+'"'+"><img src='/comm/images/play.png'></a>");
			if (blnGProcessActive==false)
			{
				$('#graphSection_STOP').html("<img src='/comm/images/stop_disable.png'>");
				$('#graphSection_RELOAD').html("<img src='/comm/images/refresh_disable.png'>");
			}
		...
		{
			// click on PDF
			$('#graphSection_PDF').html("<a href='' onClick="+'"'+"createPDF();return false;"+'"'+"><img src='/comm/images/PDF_downlaod_shadow.png'></a>");
			$('#graphSection_PNG').html("<br><a href='' onClick="+'"'+"createPNG();return false;"+'"'+"><img src='/comm/images/PNG_downlaod_shadow.png'></a>");
			$('#graphSection_STOP').html("<img src='/comm/images/stop_disable.png'>");
			$('#graphSection_PLAY').html("<br><a href='' onClick="+'"'+"submitGraph();return false;"+'"'+"><img src='/comm/images/play.png'></a>");
			$('#graphSection_PLAYInit').html("<br><a href='' onClick="+'"'+"submitGraph();return false;"+'"'+"><img src='/comm/images/play.png'></a>");
			$('#graphSection_RELOAD').html("<img src='/comm/images/refresh_disable.png'>");
		...
		else
		{
			...
			if (strType=="LOAD")				
			{
				$('#graphSection_PDF').html("<img src='/comm/images/PDF_downlaod_disable.png'>");
				$('#graphSection_PNG').html("<img src='/comm/images/PNG_downlaod_disable.png'>");
				$('#graphSection_PLAY').html("<br><img src='/comm/images/play_disable.png'>");
				$('#graphSection_PLAYInit').html("<br><img src='/comm/images/play_disable.png'>");
				$('#graphSection_STOP').html("<br><a href='' onClick="+'"'+"_stopGraph();return false;"+'"'+"><img src='/comm/images/stop.png'></a>");
				$('#graphSection_RELOAD').html("<br><a href='' onClick="+'"'+"_reloadGraph();return false;"+'"'+"><img src='/comm/images/refresh.png'></a>");				
				blnReset=1;
			}	
			else			
				blnReset=1;			
