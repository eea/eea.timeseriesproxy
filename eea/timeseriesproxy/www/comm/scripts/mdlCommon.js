...
function _configureGraph(blnOpen,blnChangeDate,blnAlreadyChanged){
	...
	if (blnOpen==1)
	{
		...
		else
		{
			...
			document.getElementById("graphSection_PLAYInit").innerHTML="<br><a href='' onClick="+'"'+"submitGraph();return false;"+'"'+"><img src='/comm/images/play.png'></a>";			
			document.getElementById("graphSection_PLAY").innerHTML="<br><a href='' onClick="+'"'+"submitGraph();return false;"+'"'+"><img src='/comm/images/play.png'></a>";			
		}
	}	
	...
	function enDisSpatialSelection(strValue){
		...
		switch(trim(strValue)){
			...
			case "s_d":							
				...
				$("#imgQueryPoint").attr("src",'./comm/images/query_point_di.png');
				$("#imgQueryBox").attr("src",'./comm/images/query_box_di.png');
				$("#imgQueryShape").attr("src",'./comm/images/query_shape.png');
			...
			case "r_d":		
				...
				$('#featureToggle').removeAttr('disabled');	
				$("#imgQueryPoint").attr("src",'./comm/images/query_point.png');
				$("#imgQueryBox").attr("src",'./comm/images/query_box.png');
				$("#imgQueryShape").attr("src",'./comm/images/query_shape.png');
...
//------------------------------------------------------------------	
	function openQueryDialog(strValue){
		...
		$("#imgQueryBox").attr("src",'./comm/images/query_box.png');
		$("#imgQueryShape").attr("src",'./comm/images/query_shape.png');
		$("#imgQueryMove").attr("src",'./comm/images/move.png');
		...
		{			
			...
			{
				$("#imgQueryPoint").attr("src",'./comm/images/query_point_on.png');
		...
		{	
			...
			if (strValue=="B")
			{
				...
				{			
					$("#imgQueryBox").attr("src",'./comm/images/query_box_on.png');
			...
			else
			{
				...
				{		
					...
					{					
						if (blnEnabledGRaster==true)
							...
							$('#shape_select').attr('disabled', 'disabled');						
						$("#imgQueryShape").attr("src",'./comm/images/query_shape_on.png');
				...
				{
					showHideLayer("","shape");
					$("#imgQueryMove").attr("src",'./comm/images/move_on.png');
...
//------------------------------------------------------------------	
	function updateNationalLinks(strMeteo,strNational){
		...
		if (strNational!="")	$("#span_url_cd_state").html("<a target=_blank href='"+strNational+"'><img title='Country link' src='/comm/images/flag.png'></a>");								
		if (strMeteo!="")		$("#span_url_nat_cl").html("<a target=_blank href='"+strMeteo+"'><img title='National Meteorological link' src='/comm/images/meteo.png'></a>");					
...
//------------------------------------------------------------------
	function loadNationalLinks(lat,lon){
		$("#span_url_nat_cl").html("<img src='/comm/images/meteo_dis.png'>");
		$("#span_url_cd_state").html("<img src='/comm/images/flag_dis.png'>");
	...
	function _returnLegendeMetadata(strVar,strDate,strID,objToAdd){
		...
		$.ajax({    
			...
			{     								
				...
				deleteImg.setAttribute("src","/comm/images/1391708526_DeleteRed.png");			
				...
				if (strMetadataLink!="")
				{
					...
					metadataImg.setAttribute("src","/comm/images/1391708694_Table_16x16.png");							
				...
				else				
				{
					...
					var metadataImg=document.createElement("img");
					metadataImg.setAttribute("src","/comm/images/dis_1391708694_Table_16x16.png");	
